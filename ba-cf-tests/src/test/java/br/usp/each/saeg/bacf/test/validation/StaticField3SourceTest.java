...
import br.usp.each.saeg.bacf.test.validation.targets.StaticField;

public class StaticField3SourceTest extends ValidationTargetsTest {

    public StaticField3SourceTest() {
