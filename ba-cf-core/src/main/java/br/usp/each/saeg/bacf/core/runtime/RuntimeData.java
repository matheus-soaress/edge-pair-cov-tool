 ...
 */
package br.usp.each.saeg.bacf.core.runtime;

import br.usp.each.saeg.bacf.core.data.ExecutionData;
import br.usp.each.saeg.bacf.core.data.ExecutionDataStore;
import br.usp.each.saeg.bacf.core.data.IExecutionDataVisitor;
...
public class RuntimeData {
    ...
    public long[] getData(final long id, final String name, final int size) {
        long[] nodeData = getExecutionData(id, name, size).getData();
        return nodeData;
    }
